...
This template shows how to adapt Deep Agents Incident Workflow for one organization
...
- `workflow.json`: trusted operator policy for repository scope, evidence caps,
  validation, the pinned Deep Agents SDK worker/tool contract, and limits.
...
5. Qualify a real Deep Agents model on synthetic data.
